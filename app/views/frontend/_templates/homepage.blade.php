...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<title>Desa Suatang Baru Website</title>
    ...
    <body>  
		<style type="text/css">		
			...
			#header-hero .banner { float:left; height: 245px; width: 960px; }
	...
	*/
        ...
        <div id="blue-header" style="padding-top:5px">
	        <div class="section-wrapper">		
				<div id="header-site-nav">
					...
					<span class="corners tl"></span><span class="corners tr"></span>
					<span class="corners bl"></span><span class="corners br"></span>
				</div>
		...
		<div id="blue-body">
			<div class="section-wrapper" style="padding-top: 194px;">
				<div id="hp-boxes">
				...
				<p style="margin-top:33px;margin-right:45px;float:right">
					<a href="{{ route('kabar-desa') }}"><img src="{{ asset('packages/web/img/btn-get-started.png') }}" alt="Get Started"></a>
				</p>

				<script type="text/javascript">
					$(document).ready(function() {

						$("#hp-offer-switch #tabs li").click(function() {
							$("#hp-offer-switch #tabs li").removeClass("active");
							$(this).addClass("active");
							var getid = "#" + $(this).attr("loadid");
							$("#hp-offer-switch #offer-body div.offer-tab").removeClass("active");
						...
						if (mm == 1 && yy == 2013 && dd > 11 && dd < 20) { 
							// this change is only effective for this week 1/12/2013 - 1/19/2013
							// activate the tab selector
							$("#hp-offer-switch #tabs li").removeClass("active");
							$('#hp-offer-switch #tabs li:last').addClass('active');

							// activate the forum tab
							$('#hp-offer-01').removeClass('active');
							$('#hp-offer-06').addClass('active');
						}
