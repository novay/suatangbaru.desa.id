...
$base_url="http://localhost:8000"; //url base of site if you want only relative url leave empty
$upload_dir = '/gallery/'; // path from base_url to upload base dir
$current_path = '/../../../../gallery/'; // relative path from filemanager folder to upload files folder
